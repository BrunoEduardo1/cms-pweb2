        ...
        <?= $this->Form->create($galeriesPhoto) ?>
           <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="caption" class="form-control" style="resize: none;" rows="3" required><?=$galeriesPhoto->caption ?></textarea>
            </div> 
            <div class="form-group">
                <div class="row">
                    <div class="col">
                        ...
                        <select class="form-control" name="galery_id">
                            ...
                            <?php foreach ($galeries as $galery) : ?>
                                <option value="<?=$galery->id?>" <?= ($galeriesPhoto->galery_id == $galery->id) ? 'selected': '';?> ><?=$galery->name?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col">  
